...
namespace ViewModel
{
    public class StudentDB : UserDB
    {
        ...
        protected override void CreateModel(BaseEntity entity)
        {
            ...
            student.ClassNumber = (int)this.reader["ClassNumber"];
            student.StartYear = (int)this.reader["StartYear"];
            student.MajorsA = this.reader["MajorA"].ToString();
            student.MajorsB = this.reader["MajorB"].ToString();
